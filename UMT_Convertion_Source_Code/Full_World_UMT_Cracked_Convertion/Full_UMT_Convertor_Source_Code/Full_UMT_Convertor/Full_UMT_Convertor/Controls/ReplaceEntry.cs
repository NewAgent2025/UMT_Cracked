...
namespace Full_UMT_Convertor.controls
{
	...
	{
		// Token: 0x0600032E RID: 814 RVA: 0x00004016 File Offset: 0x00002216
		public ReplaceEntry(replaceEntryActive)
		{
			this.method_2();
			this.replaceEntryActive = replaceEntryActive;
			this.method_0();
		}

		// Token: 0x0600032F RID: 815 RVA: 0x00004031 File Offset: 0x00002231
		public ReplaceEntry(replaceEntryActive, replaceValue)
		{
			/*
An exception occurred when decompiling this method (0600032F)

ICSharpCode.Decompiler.DecompilerException: Error decompiling System.Void Full_UMT_Convertor.controls.ReplaceEntry::.ctor(<<<NULL>>>,<<<NULL>>>)
...
*/;
		...
		// Token: 0x06000330 RID: 816 RVA: 0x0000406D File Offset: 0x0000226D
		...
		// Token: 0x06000331 RID: 817 RVA: 0x0001B4D0 File Offset: 0x000196D0
		private void XoyWuxXdXT(object sender, EventArgs e)
		{
			int num = base.Width;
			...
			this.textBox_0.Left = this.comboBox_0.Left + this.comboBox_0.Width + 5;
		}

		// Token: 0x06000332 RID: 818 RVA: 0x000040A5 File Offset: 0x000022A5
		public  GetReplacement()
		{
			/*
An exception occurred when decompiling this method (06000332)

ICSharpCode.Decompiler.DecompilerException: Error decompiling <<<NULL>>> Full_UMT_Convertor.controls.ReplaceEntry::GetReplacement()
...
*/;
		...
		// Token: 0x06000333 RID: 819 RVA: 0x00003A2B File Offset: 0x00001C2B
		...
		// Token: 0x06000334 RID: 820 RVA: 0x000040D2 File Offset: 0x000022D2
		private void textBox_1_Enter(object sender, EventArgs e)
		{
			/*
An exception occurred when decompiling this method (06000334)

ICSharpCode.Decompiler.DecompilerException: Error decompiling System.Void Full_UMT_Convertor.controls.ReplaceEntry::textBox_1_Enter(System.Object,System.EventArgs)
...
*/;
		...
		// Token: 0x06000335 RID: 821 RVA: 0x000040D2 File Offset: 0x000022D2
		internal void method_1()
		{
			/*
An exception occurred when decompiling this method (06000335)

ICSharpCode.Decompiler.DecompilerException: Error decompiling System.Void Full_UMT_Convertor.controls.ReplaceEntry::method_1()
...
*/;
		...
		// Token: 0x06000336 RID: 822 RVA: 0x000040E0 File Offset: 0x000022E0
		...
		// Token: 0x06000337 RID: 823 RVA: 0x0001B558 File Offset: 0x00019758
		private void method_2()
		{
			...
			this.textBox_0.Name = "tbCompareValue";
			...
			this.comboBox_0.Name = "cbNodeType";
			...
			this.textBox_1.Name = "tbNodePath";
			...
			base.Name = "ReplaceEntry";
			base.Size = new Size(542, 26);
			base.Resize += this.XoyWuxXdXT;
			base.ResumeLayout(false);
			base.PerformLayout();
		}

		// Token: 0x040001FE RID: 510
		private  replaceEntryActive;
