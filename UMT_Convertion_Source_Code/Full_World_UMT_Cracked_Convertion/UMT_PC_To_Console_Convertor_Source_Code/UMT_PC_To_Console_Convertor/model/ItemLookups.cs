...
namespace UMT_PC_To_Console_Convertor.model
{
	...
	public class ItemLookups
	{
		...
		// (get) Token: 0x06000783 RID: 1923 RVA: 0x0000638F File Offset: 0x0000458F
		public static Dictionary<string, Item> ItemsByName
		{
			get
			{
				return ItemLookups.dictionary_1;
			}
		}

		// Token: 0x1700014C RID: 332
		// (get) Token: 0x06000784 RID: 1924 RVA: 0x00006396 File Offset: 0x00004596
		public static Dictionary<int, Item> ItemsById
		{
			get
			{
				return ItemLookups.dictionary_0;
			}
		}

		// Token: 0x06000785 RID: 1925 RVA: 0x0002D6D0 File Offset: 0x0002B8D0
		public static void LoadItemsById()
		{
			ItemLookups.dictionary_0 = new Dictionary<int, Item>();
			foreach (Item item in ItemLookups.dictionary_1.Values)
			{
				ItemLookups.dictionary_0.Add(item.Id, item);
			}
		}
