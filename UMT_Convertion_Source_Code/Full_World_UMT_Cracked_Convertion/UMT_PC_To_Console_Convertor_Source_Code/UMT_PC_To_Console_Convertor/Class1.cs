...
{
	// Token: 0x06000005 RID: 5 RVA: 0x0000700C File Offset: 0x0000520C
	...
	// Token: 0x06000006 RID: 6 RVA: 0x0000243C File Offset: 0x0000063C
	...
	// Token: 0x06000008 RID: 8 RVA: 0x0000706C File Offset: 0x0000526C
	...
	// Token: 0x06000009 RID: 9 RVA: 0x000070F0 File Offset: 0x000052F0
	...
	// Token: 0x0600000A RID: 10 RVA: 0x00007128 File Offset: 0x00005328
	...
	// Token: 0x0600000B RID: 11 RVA: 0x00007174 File Offset: 0x00005374
	...
	// Token: 0x0600000C RID: 12 RVA: 0x000071C0 File Offset: 0x000053C0
	public static byte[] smethod_7(this string string_0)
	{
		...
		{
			Class1.func_0 = new Func<int, bool>(Class1.smethod_20);
		}
		return (from x in source.Where(Class1.func_0)
		select Convert.ToByte(string_0.Substring(x, 2), 16)).ToArray<byte>();
	}

	// Token: 0x0600000D RID: 13 RVA: 0x00007254 File Offset: 0x00005454
	...
	// Token: 0x0600000E RID: 14 RVA: 0x000072D4 File Offset: 0x000054D4
	...
	// Token: 0x0600000F RID: 15 RVA: 0x0000732C File Offset: 0x0000552C
	...
	// Token: 0x06000010 RID: 16 RVA: 0x000074F0 File Offset: 0x000056F0
	...
	// Token: 0x06000011 RID: 17 RVA: 0x0000247D File Offset: 0x0000067D
	...
	// Token: 0x06000012 RID: 18 RVA: 0x00007540 File Offset: 0x00005740
	...
	// Token: 0x06000013 RID: 19 RVA: 0x0000248D File Offset: 0x0000068D
	public static byte[] smethod_14(Stream stream_0, byte[] byte_0)
	{
		return new HMACSHA1(byte_0).ComputeHash(stream_0);
	}

	// Token: 0x06000014 RID: 20 RVA: 0x0000249B File Offset: 0x0000069B
	...
	// Token: 0x06000015 RID: 21 RVA: 0x00007588 File Offset: 0x00005788
	...
	// Token: 0x06000017 RID: 23 RVA: 0x000075D0 File Offset: 0x000057D0
	...
	// Token: 0x06000018 RID: 24 RVA: 0x000076F4 File Offset: 0x000058F4
	public static byte[] smethod_19(byte[] byte_0, byte[] byte_1, int int_0)
	{
		Array.Resize<byte>(ref byte_0, 16);
		Aes aes = Aes.Create();
		aes.Key = byte_0;
	...
	// Token: 0x06000019 RID: 25 RVA: 0x000024B9 File Offset: 0x000006B9
	[CompilerGenerated]
	private static bool smethod_20(int int_0)
	{
		return int_0 % 2 == 0;
	}
